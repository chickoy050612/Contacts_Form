...
function validateContactEmail(){
	...
	if(!isset($_POST['em_email'])){
		...
		//--------------------------------------------------------------------
		// 4. Ensures that email address entered on the form is properly formated
		// {ex. user@localhost.xxx}
		//--------------------------------------------------------------------
		// Allowing @, and .com in email address
		...
		if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
			...
			$err_msgs[] = "The email is not valid";
		}
